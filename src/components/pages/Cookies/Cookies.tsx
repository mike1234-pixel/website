  ...
  return (
    <div className={styles.root}>
      <Container>
        ...
        <p>
          Our website uses cookies to improve your experience and to analyze how
          our website is used. Cookies are small text files that are placed on
        ...
        <ul>
          <li>
            ...
            our website and cannot be turned off in our system. They are usually
            set in response to actions made by you, such as setting your privacy
        ...
        <p>
          You can control cookies through your browser settings. However, please
